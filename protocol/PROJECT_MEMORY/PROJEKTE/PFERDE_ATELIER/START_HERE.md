...
- `GLOSSAR/START_HERE.md` → öffentliches Glossar: Struktur, Kurztexte, SEO-/WordPress-Konzept und Übergabe an DESIGN/TEXT; Fachfakten bleiben in der Wissensdatenbank
