...
docker run -d --name wp --network ugeup -p 8080:80 -e WORDPRESS_DB_HOST=db:3306 -e WORDPRESS_DB_NAME=wordpress -e WORDPRESS_DB_USER=wp -e WORDPRESS_DB_PASSWORD=wp -v /tmp/runtime-plugin:/var/www/html/wp-content/plugins wordpress:php8.1-apache >/dev/null
