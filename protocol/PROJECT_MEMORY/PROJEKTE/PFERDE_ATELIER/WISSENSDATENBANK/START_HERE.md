...
Das Büro arbeitet in vier Ebenen:
...
## Wenn der Nutzer fragt: „Welche Themen sind offen?“
1. `THEMENPOOL.md` lesen.
2. Themen mit Status `IDEE`, `PRUEFEN` oder `NACHRECHERCHE` nennen.
3. Aktive/recherchierte Themen nicht als offen ausgeben.

## Wenn der Nutzer sagt: „Recherchiere!“
1. aktuellen `HOBBYRAUM.md` prüfen;
2. im `THEMENPOOL.md` das gebundene/naheliegende offene Thema bestimmen;
3. `RECHERCHE_STANDARD.md` anwenden;
...
# RECHERCHE-TRUST – KURZREGEL

Grundsätzlich werden Quellen in dieser Reihenfolge bevorzugt:
1. staatliche / supranationale / offizielle Fachinstitutionen;
2. zuständige offizielle Verbände, Zuchtbücher, Regelgeber, Universitäten, wissenschaftliche Fachgesellschaften;
3. peer-reviewte Fachliteratur / anerkannte Forschung;
4. etablierte Fachinstitutionen, Museen, Archive, Bibliotheken;
5. hochwertige Fachmedien nur ergänzend.

Nicht als Hauptbeleg für harte Fakten:
- SEO-Seiten ohne Primärquellen;
- Händlertexte;
- Affiliate-Seiten;
- generische Blogs;
- KI-generierte oder nicht nachvollziehbar redigierte Inhalte;
- Foren/Social Media außer als Hinweisquelle.

Themenspezifische strengere Regeln stehen in `RECHERCHE_STANDARD.md`.
