...
- die eigentliche Textproduktion;
- Sprache/Stil/Tabellen/Links/LanguageTool;
- den bestehenden Produktions-Handoff.

ACM orchestriert nur.
Affiliate bleibt Commerce-Schicht.

Kein zweiter Produktvergleichs-Writer im Zielbetrieb.
...
6. `protocol/PROJECT_MEMORY/ZIELVERTRAEGE/REGISTER.md`.
