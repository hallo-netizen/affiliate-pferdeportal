...
| M22 | H8 Provenance / Integrität ohne interne Signatur | **AKTUELLER PRE-MERGE-REGRESSIONBLOCKER: `M22_INTERNAL_SIGNATURE_STILL_REQUIRED`** | Root Cause gegen TECH-KEYFLOW-001/B15 belegt. Current main trägt wieder alte Signed-Binding-/Signer-Pflicht. Kandidat `13d76a2b22b2794827f6a277f7d85ab1566e19d3` stellt internen Hash-/Batch-/Herkunftsweg wieder her, lässt externe M23-ED25519-Prüfung bestehen. Source-level main FAIL / Kandidat PASS; Boundary 11/11 Blob-Bindungen konsistent; zusätzlich nur die bestehende H8→STEP107007→State→Root/Pointer-Hashkette aktualisiert. |
