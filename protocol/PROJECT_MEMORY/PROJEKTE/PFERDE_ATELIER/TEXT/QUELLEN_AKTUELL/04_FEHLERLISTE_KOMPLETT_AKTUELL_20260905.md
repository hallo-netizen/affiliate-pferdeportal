...
| M17 | 107008 fail-closed | **AKTUELLER PRE-MERGE-REGRESSIONBLOCKER: `M17_HOST_FINALIZATION_NOT_FAIL_CLOSED`** | History Authority PR #198 ist auf main `6e650edce60b24baf7d7feef66e60cca2817e59e` integriert. KISS-Kandidat jetzt Head `66e9f24a06a6ddb37fd5e8e50f4c158965263abd`: genau 1 Logikdatei ergänzt die fehlende Prüfung `ok=true` + `PSERC_FINAL_PACKAGE_PASS`; 5 weitere Dateien sind ausschließlich die bereits vorhandene Hash-Refresh-Kette. Lokal: M16 PASS, M17 positiv PASS, fehlender Guard BLOCK, falsche Reihenfolge BLOCK, Hash-Kette konsistent. Serverseitig: current main reproduziert M17; M17-Kandidat passiert M01–M21 und erreicht anschließend M22. Damit ist M17 isoliert behoben; die Zwangsjacke wird KISS auf sequenzielles Weiterreichen zu einem späteren bereits bekannten FAIL korrigiert. M35 bleibt geparkt. |
