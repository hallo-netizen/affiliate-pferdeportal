...
| M17 | 107008 fail-closed | **AKTUELLER PRE-MERGE-REGRESSIONBLOCKER: `M17_HOST_FINALIZATION_NOT_FAIL_CLOSED`** | History Authority PR #198 ist auf main `6e650edce60b24baf7d7feef66e60cca2817e59e` integriert. Ein-Datei-KISS-Kandidat `6dcf42daa1dfc0e7960a17da49f8ca2dfee2b5ba` ergänzt ausschließlich die fehlende Prüfung `ok=true` + `PSERC_FINAL_PACKAGE_PASS` vor Clear/Final-PASS. Lokal: M16 PASS, M17 positiv PASS, fehlender Guard BLOCK, falsche Reihenfolge BLOCK. Serverseitige M01–M35-Abnahme noch offen. M35 bleibt geparkt. |
