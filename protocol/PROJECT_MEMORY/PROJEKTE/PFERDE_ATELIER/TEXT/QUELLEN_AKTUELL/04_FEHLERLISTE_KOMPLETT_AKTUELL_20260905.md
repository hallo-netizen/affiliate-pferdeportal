...
| M36 | Persisted H8 legacy-binding compatibility after provenance migration | **INTEGRIERT BEHOBEN 09.09.2026** | History PR #203 + Produktfix PR #204 regulär integriert; main `93ba987c56f7b08ffba009210e3012c036fec18d`. Maschinenbeweis: current main vor Fix erster FAIL M36, Kandidat M01–M36 Gesamt-PASS; hardlock + hardlock-base PASS; Bypass leer. Fix ausschließlich read-only Legacy-Alias bei exakt aktueller Provenienzidentität; unbekannter Vertrag/falsche Generation BLOCK. Neuer echter 7/7-Realtest danach ist nächste Aktion. |
