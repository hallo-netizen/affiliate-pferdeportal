...
| M17 | 107008 fail-closed | **INTEGRIERT BEHOBEN 09.09.2026** | PR #199 regulär über `hardlock` + `hardlock-base` gemergt; main `7531154a6218a06e49d35b78062933df3c886625`. Maschinenbeweis vor Merge: current main erster FAIL M17, Kandidat danach erster bekannter FAIL M22. |
...
| M22 | H8 Provenance / Integrität ohne interne Signatur | **INTEGRIERT BEHOBEN 09.09.2026** | PR #201 regulär gemergt; main `a63c20100759b4e42d07f2e70a11ee9875709d37`. Maschinenbeweis: current main erster FAIL M22, Kandidat danach erster FAIL M26. Externe M23-Signaturprüfung blieb erhalten. |
...
| M26 | Bound Fachworkflow production context | **INTEGRIERT BEHOBEN 09.09.2026** | PR #202 regulär gemergt; main `d32e16cdf6b45ffa282e42fa78e07da84863e362`. Maschinenbeweis: current main erster FAIL M26, Kandidat danach erster FAIL M35. Funktional blieb der Kontext unverändert; nur Markerwortlaut + Hashkette. |
...
| M36 | Persisted H8 legacy-binding compatibility after provenance migration | **AKTUELLER REALBLOCKER: `H8_BOOTSTRAP_PROVENANCE_BINDING_NOT_CURRENT`** | Nach M01–M35 Gesamt-PASS stoppte der echte 7/7-Realtest vor `CURRENT_BOUND_ACTION_READY`. Runtime-/Batch-/Snapshot-/Manifest-Identität ist aktuell; persistiertes Generation-1-Paket trägt ausschließlich den alten H8-Vertrag `PFERDE_ATELIER_H8_BOOTSTRAP_SIGNED_BINDING_V1`. History-Kandidat `2465052149974f52cfb84797cf369cea430c23cc` ergänzt einen echten Persisted-Package-Positivtest sowie Negativtests für falsche Generation und unbekannten Vertrag. Produktfix noch nicht begonnen. |
