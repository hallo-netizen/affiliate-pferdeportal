...
| M36 | Persisted H8 legacy-binding compatibility after provenance migration | **AKTUELLER PRODUCT-FIX-BLOCKER: `H8_BOOTSTRAP_PROVENANCE_BINDING_NOT_CURRENT`** | History Authority PR #203 ist auf main `239a64261c1fbaf467d0adbd5a2bb1ad2139eca4` integriert und reproduziert M36 ausführbar. Produktkandidat `fceee7f1959ed2597489a86161b92a024d5a30fc`: bestehender Provenance-Guard akzeptiert ausschließlich den alten H8-Vertragsnamen als read-only Alias, wenn alle sieben aktuellen Provenienzidentitäten exakt passen; unbekannter Vertrag/falsche Generation bleiben BLOCK. 1 Logikdatei + 5 reine Bindungsdateien. Server-Gesamttest M01–M36 noch offen. |
