...
PLAN_PHASE: M28_REQUEST_FIRST_PRODUCTION_FIX
...
CURRENT_STATE_BLOB_SHA: 3b210d26c5a8b2aa18bfa5ec055ef76054ea3509
...
PROTOCOL_SOURCE_BLOB_SHA: bb51d37adaf46badbc87d5b9c37542a046e1389f
...
**Erster serverseitiger Maschinen-Test des gebundenen M28-Kandidaten.**
...
Head:
`78263594456bb58ae004b5b064816de0f3531720`
...
4. normaler `hardlock` + `hardlock-base` müssen PASS sein.

Bis dieses Ergebnis real vorliegt:
- kein Merge;
- kein Realtest;
- kein weiterer Fix;
