...
class Point0V2Tests(unittest.TestCase):
    ...
    def test_chat_start_required_tamper_and_dataforseo_blocked(self):
        p0=fixture(); snap=copy.deepcopy(p0['production_snapshot']); receipt=chat_start_gate.validate(snap); self.assertEqual(receipt['contract'],chat_start_gate.START_RECEIPT_CONTRACT)
    ...
    def test_point0_and_prewrite_tamper_fail_closed(self):
        p0=fixture(); point0_snapshot.verify(p0); chat_start_gate.validate(p0['production_snapshot'])
