...
def bind_point0(point0_path:Path, workspace:Path, *, actual_manifest:str, actual_head:str, item_index:int=0)->dict:
    ...
    receipt={'contract':'SYSTEM4_ROOT_POINT0_RECEIPT_V1','point0_sha256':state['point0_sha256'],'production_snapshot_sha256':state['production_snapshot_sha256'],'research_pool_sha256':state['research_pool_sha256'],'root_manifest_sha256':actual_manifest,'head_sha':actual_head,'article_index':state['article_index'],'phase':'RESEARCH_REQUIRED','publish_allowed':False}
...
def dispatch(workspace:Path)->dict:
    ...
    for k in ('point0_sha256','head_sha','article_index','publish_allowed'):
