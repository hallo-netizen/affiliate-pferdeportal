...
`gebundene Metadaten -> Codex recherchiert -> Codex bildet Fakten/Fact-Pack -> Codex schreibt -> unveränderte echte Prüfer -> gezielte Reparatur desselben Artikels -> Batchprüfung -> exakter Chat-/WordPress-Handoff`
...
- relevante Negativfälle: 0 Artikel, falsche/erfundene Fakten, Design-Drift, Text-/Template-Wiederholung, breiter Repair, Metadaten-/Hash-/Publish-Manipulation, Handoff-/Part-Manipulation;
