...
TMP=/tmp/run-v653-full-release-v3-generated.sh
python3 - "$BASE" "$TMP" <<'PY'
...
# The binding V6.52 predecessor gate is contractually tied to database v651gate.
# Reuse that same isolated test DB for the successor stages and reset it between
# real-WordPress installations; this changes test infrastructure only.
