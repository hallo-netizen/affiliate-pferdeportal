...
[ "$(git hash-object .github/v652/runner/v652_gate_target.sh.gz.b64)" = "af69d7f6c4c93a19657f055bc351f8e04fae6b55" ] || { echo 'BLOCKED: V6.52 exact gate target blob mismatch'; exit 1; }
...
j += len(end)
replacement=r'''[ "$(git hash-object .github/v652/runner/v652_gate_target.sh.gz.b64)" = "af69d7f6c4c93a19657f055bc351f8e04fae6b55" ] || { echo 'BLOCKED: V6.52 exact gate target blob mismatch'; exit 1; }
base64 -d .github/v652/runner/v652_gate_target.sh.gz.b64 | gzip -d > .github/v651_gate/run-v651-full-release.sh
