...
new=(
    ...
    + sep +
    "python3 .github/v652/runner/patch_v652_bash_local_nounset.py .github/v651_gate/run-v651-full-release.sh"
    + sep +
    "echo '105a1177d07a22bafbeea9e5c5e44938d66fcb530b06bb4a2b158e533c647021  .github/v651_gate/run-v651-full-release.sh' | sha256sum -c -"
)
if s.count(old)!=1:
