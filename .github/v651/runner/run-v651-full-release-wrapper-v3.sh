...
[ "$(git hash-object .github/v651/runner/05_v645_transport_contract_runner.patch)" = "7d690744f4b35f4ad5031afae6e0305be6cd3c6b" ] || { echo 'BLOCKED: V6.45 transport-contract patch blob mismatch'; exit 1; }
