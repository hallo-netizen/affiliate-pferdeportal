...
/* V6.55 CSS-only: feste Bildgeometrie fuer Produktvorschlaege auf Produkt-/Kategorieseiten.
   Ausschliesslich die Bildflaeche wird vereinheitlicht; Auswahl, Inhalte, Karten- und Buttondesign bleiben unveraendert. */
.ppar-slot-product_after_category_tiles .ppar-banner-image-wrap,
...
.ppar-slot-product_after_category_tiles .ppar-banner-image,
...
if "V6.55 CSS-only: feste Bildgeometrie" in text:
    raise SystemExit("BLOCKED: image-frame patch already present")
path.write_text(text + SUFFIX, encoding="utf-8")
print("CATEGORY_PRODUCT_IMAGE_FRAME_PATCH=PASS")
